...
# Focus on the speciesnames used in Europe
...
write_csv(country_per_species, here("data", "interim", "country_per_species.csv"), na = "")
```
...
write_csv(species_per_country, here("data", "interim", "species_per_country.csv"), na = "")
```
