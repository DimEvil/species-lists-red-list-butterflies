...
This spreadsheet contains four different worksheets: `taxa_europe`, `taxa_regional`, `regional_threat_scores` and `references`. We select these here and save them as separate data frames:
