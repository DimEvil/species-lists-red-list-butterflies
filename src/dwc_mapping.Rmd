...
write.csv(country_info, file = country_info_file, na = "", row.names = FALSE, fileEncoding = "UTF-8")
```


The country_info data will be used for the calculations of the weighted_red_list_values here: script[scr](https://github.com/inbo/red-lists-european-butterflies-checklist/blob/master/src/weighted_red_list_values.Rmd)
