...
```{r}
write_csv(table3, here::here("data", "integrating_rl", "weighted_species_list.csv"), na = "")
```
...
ggsave(mean_rlc_sqrt_area_plot, file = here("images/mean_rlv_per_sqrt_area.jpg"), device = "jpeg", dpi = 300, height = 6, width = 10)
```
